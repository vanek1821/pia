...
public class RoleRepoTest {
	...
	public void testRoleManipulation() {
		...
		Assertions.assertEquals(3, roleRepo.count());
		...
		log.info("Found user role.");
		log.info("Looking for accountant role.");
		Role accRole = roleRepo.findByCode("ACCOUNTANT");
		Assertions.assertNotNull(accRole);
		log.info("Found accountant role.");
